'use strict';
    ...
    for (let iter = 0; iter < MAX_ITER; iter++) {
      const { data } = await axios.post(url, {
        ...
        // ANY = paksa model panggil minimal 1 tool sebelum jawab.
        // Ini wajib untuk agent crypto agar tidak jawab dari training data.
    ...
    '- Analisis token EVM (ada CA 0x...): analyzeTokenSecurity\n' +

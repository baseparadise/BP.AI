...
const SYSTEM_PROMPT_BASE = [
  ...
  'PANJANG JAWABAN: Untuk pertanyaan teks biasa (bukan kode), MAKSIMAL 3800 karakter total (setara 2 pesan Discord). Jawab ringkas, padat, dan to-the-point — utamakan poin paling penting, buang pengulangan, basa-basi, dan detail yang tidak diminta. Jika ada daftar panjang, pilih 3-5 item terpenting saja. Jangan menulis ulang pertanyaan user. Targetkan 1500-2500 karakter untuk pertanyaan biasa, sampai 3800 karakter hanya untuk pertanyaan yang benar-benar kompleks.',
].join(' ');

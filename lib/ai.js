...
const PROVIDERS = {
  groq: {
    ...
    buildRequest(model, key, { question, history = [], isDMOwner = false }) {
      ...
      return {
        ...
        body: {
          model,
          // [FIX] max_tokens mencegah respons terpotong di tengah kode
          max_tokens: 8192,
          messages: [
    ...
    parseResponse(data) {
      ...
      // [FIX] Log jika respons terpotong karena token limit
  ...
  gemini: {
    ...
    buildRequest(model, key, { question, history = [], isDMOwner = false }) {
      ...
      return {
        ...
        body: {
          ...
          tools: [{ google_search: {} }],
          // [FIX] Batasi output agar tidak truncate
          generationConfig: {
    ...
    parseResponse(data) {
      ...
      // [FIX] Log jika Gemini berhenti karena MAX_TOKENS
